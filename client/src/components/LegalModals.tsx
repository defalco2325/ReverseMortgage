    ...
    <LegalModal
      ...
      content={
        <div className="space-y-6 text-sm">
          <p className="text-xs text-muted-foreground">Updated: June 3, 2024</p>
          ...
          <h3 className="text-lg font-bold mt-6">1. NOTICE AND AGREEMENT</h3>
          <p>
          ...
          <h3 className="text-lg font-bold mt-6">2. LIMITED LICENSE AND OWNERSHIP</h3>
          <p>
          ...
          <h3 className="text-lg font-bold mt-6">3. USE OF CONTENT</h3>
          <p>
          ...
          <h3 className="text-lg font-bold mt-6">4. DISCLAIMERS</h3>
          <p>
          ...
          <h3 className="text-lg font-bold mt-6">5. LIMIT ON DAMAGES</h3>
          <p>
          ...
          <h3 className="text-lg font-bold mt-6">6. INDEMNITY</h3>
          <p>
          ...
          <h3 className="text-lg font-bold mt-6">7. DISPUTE RESOLUTION</h3>
          ...
          <h3 className="text-lg font-bold mt-6">8. LINKS TO THIRD-PARTY SITES</h3>
          <p>
          ...
          <h3 className="text-lg font-bold mt-6">9. SUBMISSIONS AND PRIVACY</h3>
          <p>
          ...
          <h3 className="text-lg font-bold mt-6">10. GOVERNING LAW</h3>
          <p>
          ...
          <h3 className="text-lg font-bold mt-6">11. COMPLETE AGREEMENT</h3>
          <p>
...
export function PrivacyNoticeModal({ children }: { children: React.ReactNode }) {
  return (
    <LegalModal
      ...
      content={
        <div className="space-y-6 text-sm">
          <p className="text-xs text-muted-foreground">Last Updated: October 14, 2024</p>
          ...
          <h3 className="text-lg font-bold mt-6">Collection and Use of Information</h3>
          ...
          <h3 className="text-lg font-bold mt-6">Purposes of Collection</h3>
          ...
          <h3 className="text-lg font-bold mt-6">Information We May Disclose or Share</h3>
          <p>
          ...
          <h3 className="text-lg font-bold mt-6">Protection of Information</h3>
          <p>
          ...
          <h3 className="text-lg font-bold mt-6">Consumer Choices</h3>
          <p>
          ...
          <h3 className="text-lg font-bold mt-6">Links to Third Party Sites</h3>
          <p>
          ...
          <h3 className="text-lg font-bold mt-6">Children's Privacy Rights</h3>
          <p>
          ...
          <h3 className="text-lg font-bold mt-6">Updates to Our Privacy Notice</h3>
          <p>
